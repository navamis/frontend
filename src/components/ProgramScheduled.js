      ...
      <div className="card">
        ...
        <div className="card-body">
          <span className="badge rounded-pill bg-dark">
            ProgramSchedule Id :{this.props.scheduleId}
          </span>
          ...
          <button
            ...
            onClick={this.deleteProgramScheduled.bind(
              this,
          ...
          <Link to={"/updateProgramScheduled/" + this.props.scheduleId}>
...
const mapDispatchToState = (dispatch) => {
  return {
    onDeleteProgramScheduled: (id) =>
      dispatch(actions.deleteProgramScheduled(id)),
  };
};
