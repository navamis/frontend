const saveUniversity = () =>{
    ...
    return {type : "ADD_UNIVERSITY",payload : {message : "Successfully added University"}}
...
export const addUniversity = (payload) =>{
    ...
    return dispatch => {
        fetch('http://localhost:8075/addUniversity', requestOptions)
            .then(res => {
                console.log(res)
                if(res.status === 201){
                    console.log("success");
...
export const deleteUniversity = (universityId) =>{
    ...
    return dispatch => {
        ...
        fetch("http://localhost:8075/deleteUniversity/" + universityId, requestOptions)
            .then(res => {
                console.log(res)
...
const updateUniversity = () =>{
    console.log('inside update University')
        return {type : "UPDATE_UNIVERSITY",payload : {message : "Successfully updated University"}}
    ...
    export const EditUniversity = (payload) =>{
        ...
        return dispatch => {
            console.log(requestOptions);
                console.log(payload);
            console.log("reached")
            fetch('http://localhost:8075/updateUniversity', requestOptions)
                .then(res => {
                    console.log(res)
                    if(res.status === 200){
